...
class App_cal extends CI_Controller {
    ...
    public function show() {
        ...
        $tpl = '
           {table_open}<table  class="table" border="1" cellpadding="15" cellspacing="1">{/table_open}
        ...
        $prefs = array (
            ...
            'day_type'          => 'short',
            'show_next_prev'    => TRUE,
            'next_prev_url'     => 'http://localhost:8080/stalin_projects/stalin_codeig_blog/app_cal/show',
            'template'          => $tpl         
         );
